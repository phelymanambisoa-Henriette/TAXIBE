...
class Arret(models.Model):
    ...
    villeRef = models.ForeignKey(Ville, on_delete=models.CASCADE, null=True, blank=True)
    quartier = models.ForeignKey(Quartier, on_delete=models.CASCADE, related_name='arrets')
